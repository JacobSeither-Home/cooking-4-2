...
import { ChefHat, ChevronLeft, ChevronRight, Check, Timer, ExternalLink } from 'lucide-react'
import { PageHeader, DecoDivider, DecoCornerFrame } from '../components/DecoFrame'
        ...
        {steps.length > 0 ? (
          <DecoCornerFrame className="card p-5 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-1">
              <button
                onClick={() => { setTimer(5 * 60); setRunning(false) }}
                className="text-[10px] text-cream/30 hover:text-cream/60 border border-border rounded px-2 py-1"
              >
                5 min
              </button>
              <button
                onClick={() => { setTimer(10 * 60); setRunning(false) }}
                className="text-[10px] text-cream/30 hover:text-cream/60 border border-border rounded px-2 py-1"
              >
                10 min
              </button>
              <button
                onClick={() => { setTimer(15 * 60); setRunning(false) }}
                className="text-[10px] text-cream/30 hover:text-cream/60 border border-border rounded px-2 py-1"
              >
                15 min
              </button>
